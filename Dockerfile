# 1. # 1. Especifica la imagen base que se usará (Node.js v20.11.1)
FROM node:20.11.1
# Usa una imagen oficial de Node.js con la versión 20.11.1 ya instalada.
...
# 6. Expone el puerto 3001 (generalmente se usa el 9090)
EXPOSE 3001
...
# docker build -t luisafg/app-pcmany-image:1.0.10-lts .

# docker pull pepeArgento/app-family:1.2.41
# docker push luisafg/app-pcmany-image:1.0.10-lts
# docker pull mauricio776/app-pcmany-image:1.0.10

# docker run -d --name app-pcmany-container -p 8080:3001 mauricio776/app-pcmany-image:1.0.10